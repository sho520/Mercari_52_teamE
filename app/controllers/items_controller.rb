class ItemsController < ApplicationController
  ...
  def item_params
    params.require(:item).permit(:name, :state_id, :size_id,:large_class_id,:middle_class_id, :category_id,:prefecture_id, :description, :condition_id, :shipping_fee_payer_id, :shipping_day_id, :price, images_attributes:[:id,:image_url])
